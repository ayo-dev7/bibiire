                ...
                <Link to=":id" className="product-card position-relative">
                    ...
                    <div className="product-details">
                        ...
                        <p className={`description ${grid === 12 ? 'd-block' : 'd-none'}`}>
                            ...
                            Qui accusantium vel doloremque doloribus reprehenderit dolorum
                            modi fugiat, ex asperiores quasi expedita illum, iure laborum
                            deserunt?
                        </p>
                    ...
                    <div className="action-bar position-absolute">
                        <div className='d-flex flex-column gap-15'>
                            ...
                            <button className='border-0 bg-transparent'><img src={addtocart} alt="add to cart" /></button>
                        </div>
                    </div>
                </Link>
            </div>
                ...
                <Link className="product-card position-relative">
                    ...
                    <div className="action-bar position-absolute">
                        <div className='d-flex flex-column gap-15'>
                            ...
                            <Link><img src={addtocart} alt="add to cart" /></Link>
                        </div>
                    </div>
                </Link>
            </div>
