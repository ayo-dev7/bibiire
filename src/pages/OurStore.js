                        ...
                        <div className="filter-card mb-3">
                            ...
                            <div>
                                <div className="product-tags d-flex flex-wrap gap-10 align-items-center">
                                    <span className='text-secondary badge bg-light rounded-3 px-3 py-2'>Headphones</span>
                                    <span className='text-secondary badge bg-light rounded-3 px-3 py-2'>Laptop</span>
                                    <span className='text-secondary badge bg-light rounded-3 px-3 py-2'>Mobile</span>
                                    <span className='text-secondary badge bg-light rounded-3 px-3 py-2'>Wire</span>
                                </div>
                            </div>
                        </div>
                        <div className="filter-card mb-3">
